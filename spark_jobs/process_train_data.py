...
# Updated for 4 Kafka brokers using internal service names and default internal port 9092
...
# Further transformations and adding 'ingestion_timestamp' will happen in foreachBatch.
...
def process_training_batch(batch_df, batch_id):
    ...
    try:
        ...
        # Apply schema and add current timestamp for ingestion
        ...
        logger.error(f"Batch {batch_id}: Error processing or writing training data: {e}", exc_info=True)
